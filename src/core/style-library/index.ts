...
} from "./assets/applied-registry-patch";
export {
  HTML_PASTE_TEAL_SECTION_LABEL_ASSET,
  HTML_PASTE_TEAL_SECTION_LABEL_ASSET_ID,
  STYLE_LIBRARY_HTML_PASTE_RUNTIME_VARIANT_IDS,
  STYLE_LIBRARY_HTML_PASTE_VARIANT_ASSETS,
} from "./assets/html-paste-variant-assets";
