...
| S11-STORY-003B | Legacy Path Removal & Parallel Implementation Audit | P0 | **In Progress**（Gate A 修订 · **Gate B 未批准** · P0 不含 LP-008 · `refactor/s11-story-003b-legacy-path-removal`） |
