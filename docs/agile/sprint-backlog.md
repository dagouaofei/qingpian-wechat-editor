...
> **专项 Sprint 12：** Product Governance & Release 2 Planning · **Approved / In Progress**（**DECISION-116** · S12-STORY-001~008 **Done** · S12-STORY-009 **In Review** · 详细：[`sprints/sprint-12/plan.md`](sprints/sprint-12/plan.md)）
...
> **状态：** **Approved / In Progress** · S12-STORY-009 **In Review** · Sprint 12 **未关闭** · Release 2 **Planned / Not Started**
...
| S12-STORY-006 | 敏捷事件、流程闸门、DoR/DoD 与标准模板              | Accepted / Done |
| S12-STORY-007 | Release 1 历史能力、模块及功能映射                  | Accepted / Done |
| S12-STORY-008 | Release 2 及后续产品路线与渐进式迭代计划            | Accepted / Done |
| S12-STORY-009 | 全局一致性审计、治理验收与 Sprint 12 Closeout       | In Review       |
