...
> **专项 Sprint 12：** Product Governance & Release 2 Planning · **Approved / In Progress**（**DECISION-116** · S12-STORY-001/002 **Done** · S12-STORY-003 **In Review** · 详细：[`sprints/sprint-12/plan.md`](sprints/sprint-12/plan.md)）
...
> **状态：** **Approved / In Progress** · S12-STORY-002 **Accepted / Done** · S12-STORY-003 **In Review**
...
| S12-STORY-003 | 完整产品模块树与产品功能目录                        | In Review               |
