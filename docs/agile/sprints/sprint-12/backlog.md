...
| 5    | S12-STORY-006 | 敏捷事件、流程闸门、DoR/DoD 与标准模板              | P1     | **In Review**               |
...
## S12-STORY-006（In Review）

**状态：** **In Review**（2026-07-06 · 执行完成，待 ChatGPT 审查与 PO 验收）
**工作分支：** `docs/s12-story-006-agile-operating-model-templates`
...
- **S12-STORY-005** **Accepted / Done** · **S12-STORY-006** **In Review**
