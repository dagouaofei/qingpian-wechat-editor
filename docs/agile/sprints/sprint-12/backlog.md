...
| 1    | S12-STORY-002 | 产品愿景、目标用户、核心场景与系统边界              | P0     | **Committed / Not Started** |
...
- **S12-STORY-002** 仍为 **Committed / Not Started**
- 启动前须完成独立 DoR 与 PO 明确授权
- Cursor 不得因 Sprint Plan Approved 而自动启动 S12-STORY-002 或后续 Story
