...
| -------------- | ----------------------------------------------------- | -------- | ------------- | ---------------------------------------------------------------------------------------------------------------- |
| **P1-S12-001** | `.cursor/rules/` 与 S12 新模板 / Operating Model 对齐 | 治理     | **In Review** | **S12-STORY-009** · FU-001 · 本轮执行 `chore/p1-s12-001-cursor-rules-operating-model-alignment`；**未标记 Done** |
