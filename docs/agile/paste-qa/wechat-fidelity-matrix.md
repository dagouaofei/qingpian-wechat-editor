...
> **状态：** Validator 已跑 · Session 2026-06-04 已回填 19 行 · **006D** Ready for PO（15 行 queued · overlay `20260605_006D`）
...
| **pasteStatus** | PASS / FAIL / WARNING / UNTESTED | 公众号实机粘贴结果；Session 2026-06-04 已测 19 行 |
...
| 实机粘贴 | 公众号后台 | **Session 2026-06-04** · 19/37 行已测 |
...
- **Paste 汇总（已测行）：** PASS 10 · WARNING 4 · FAIL 5 · UNTESTED 18  
...
| S8M-TITLE-002 | title | title_left_bar_classic | candidate | s8-title-left-bar | border-left, padding, margin, background-color | section > h1[style*=border-left] | mixed | FAIL | WECHAT_COPY_RED_CSS | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_CSS_WITHOUT_WAIVER, WECHAT_COPY_YELLOW_CSS_WITHOUT_WAIVER, WECHAT_COPY_YELLOW_CSS_WITHOUT_WAIVER, WECHAT_COPY_YELLOW_CSS_WITHOUT_WAIVER, … | — | FAIL | 错误的显示成了左右三等分，最左侧的方框和竖线分别显示到了第一等分和第二等分区域 | See DRIFT-S8-20260604-001 · 006C copy-safe-title-divider on h1; needs 006D re-paste · 006C changed Copy HTML; queued for 006D re-paste | candidate: not in default preset until Matrix PASS · 006D-session-2026-06-05 · prev=FAIL (错误的显示成了左右三等分，最左侧的方框和竖线分别显示到了第一等分和第二等分区域) |
| S8M-TITLE-003 | title | title_bottom_line_editorial | existing | s8-title-bottom-line | text-align:center, border, padding, font-size | section > h1[style*=border-bottom] | mixed | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_CSS_WITHOUT_WAIVER, WECHAT_COPY_YELLOW_CSS_WITHOUT_WAIVER, WECHAT_COPY_YELLOW_CSS_WITHOUT_WAIVER | — | FAIL | 标题文字下面的线显示成了很高度很高的贯穿左右的长方形，而且错误的显示了边框 | See DRIFT-S8-20260604-002 · 006C border-bottom on h1; needs 006D re-paste · 006C changed Copy HTML; queued for 006D re-paste | 006D-session-2026-06-05 · prev=FAIL (标题文字下面的线显示成了很高度很高的贯穿左右的长方形，而且错误的显示了边框) |
...
| S8M-HEAD-004 | heading | heading_card_centered | existing | s8-heading-card-centered | background-color, border-radius, padding, text-align:center | section > h3[style*=background] | mixed | FAIL | WECHAT_COPY_RED_CSS | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_CSS_WITHOUT_WAIVER | — | WARNING | 没有显示上下两条横线 | See DRIFT-S8-20260604-008 · 006C borders on h3; needs 006D re-paste · 006C changed Copy HTML; queued for 006D re-paste | 006D-session-2026-06-05 · prev=WARNING (没有显示上下两条横线) |
| S8M-PARA-001 | paragraph | paragraph_plain_body | existing | s8-paragraph-plain | font-size, line-height, color, margin | p[style*=inline] | green | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG | — | PASS | MP editor 2026-06-04 · 维多 | No action; paste PASS · 006C changed Copy HTML; queued for 006D re-paste | 006D-session-2026-06-05 · prev=PASS (MP editor 2026-06-04 · 维多) |
...
| S8M-PARA-004 | paragraph | paragraph_callout_soft | probe | s8-paragraph-callout-probe | section wrapper, padding, border-radius | section > p (callout expansion layout) | yellow | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG | — | FAIL | 没有显示卡片边框和背景色 | See DRIFT-S8-20260604-005 · 006C copy-safe-card on p; needs 006D re-paste · 006C changed Copy HTML; queued for 006D re-paste | probe: Probe soft-card / section wrapper for paragraph expansion · 006D-session-2026-06-05 · prev=FAIL (没有显示卡片边框和背景色) |
...
| S8M-LEAD-003 | lead | lead_quote_intro | existing | s8-lead-quote-intro | border-left, padding, font-style, color | p[style*=border-left] | mixed | FAIL | WECHAT_COPY_RED_CSS | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG | — | WARNING | 没有显示最左侧的竖线 | See DRIFT-S8-20260604-009 · 006C border-left on p; needs 006D re-paste · 006C changed Copy HTML; queued for 006D re-paste | 006D-session-2026-06-05 · prev=WARNING (没有显示最左侧的竖线) |
| S8M-LIST-001 | list | list_plain_bullets | existing | s8-list-plain-bullets | margin, padding, line-height | ul/ol > li[style*=inline] | green | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG | — | PASS | MP editor 2026-06-04 · 维多 | No action; paste PASS · 006C changed Copy HTML; queued for 006D re-paste | 006D-session-2026-06-05 · prev=PASS (MP editor 2026-06-04 · 维多) |
...
| S8M-SUM-004 | summary | highlight_border_glow | probe | s8-summary-border-glow-probe | box-shadow, border-radius, section wrapper | section > p glow card | yellow | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG | — | FAIL | 没有显示卡片边框和背景色 | See DRIFT-S8-20260604-006 · 006C copy-safe-card on p; needs 006D re-paste · 006C changed Copy HTML; queued for 006D re-paste | probe: Probe Yellow box-shadow / glow on summary (highlight) expansion · 006D-session-2026-06-05 · prev=FAIL (没有显示卡片边框和背景色) |
| S8M-CARD-001 | info_card | info_card_key_takeaway | existing | s8-info-key-takeaway | background-color, padding, border, font-size | section > div/p card | mixed | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG | — | WARNING | 没有显示卡片边框和背景色 | See DRIFT-S8-20260604-004 · 006C copy-safe-card on p; needs 006D re-paste · 006C changed Copy HTML; queued for 006D re-paste | 006D-session-2026-06-05 · prev=WARNING (没有显示卡片边框和背景色) |
...
| S8M-CARD-004 | info_card | info_card_soft_banner | probe | s8-info-soft-banner-probe | box-shadow, border-radius, section wrapper | section > info banner | yellow | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG | — | FAIL | 没有显示卡片背景色和左侧竖线 | See DRIFT-S8-20260604-007 · 006C copy-safe-left-border+card on p; needs 006D re-paste · 006C changed Copy HTML; queued for 006D re-paste | probe: Probe info_card expansion banner / Yellow decoration · 006D-session-2026-06-05 · prev=FAIL (没有显示卡片背景色和左侧竖线) |
| S8M-CTA-001 | cta | cta_plain_text | existing | s8-cta-plain | font-size, color, text-align, margin | p[style*=inline] | green | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG | — | PASS | MP editor 2026-06-04 · 维多 | No action; paste PASS · 006C changed Copy HTML; queued for 006D re-paste | 006D-session-2026-06-05 · prev=PASS (MP editor 2026-06-04 · 维多) |
...
| S8M-DIV-001 | divider | divider_simple_line | existing | s8-divider-line | border, margin, height | hr or div line | green | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_CSS_WITHOUT_WAIVER | — | PASS | MP editor 2026-06-04 · 维多 | No action; paste PASS · 006C changed Copy HTML; queued for 006D re-paste | 006D-session-2026-06-05 · prev=PASS (MP editor 2026-06-04 · 维多) |
...
| S8M-HARVEST-001 | heading | heading_purple_chapter_label_candidate | candidate | s8-harvest-evidence-001-candidate | display:inline-block, background-color, color, font-size, font-weight, section wrapper | section > p label + h3 title (harvest candidate) | mixed | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG | — | UNTESTED | — | Track in Matrix; Paste QA in STORY-006; waiver only with evidence · 006C changed Copy HTML; queued for 006D re-paste | candidate: not in default preset until Matrix PASS · sourceEvidenceId: WX-HARVEST-EVIDENCE-001 · release1Eligible: false · 006D-session-2026-06-05 · prev=UNTESTED (—) |
| S8M-HARVEST-002 | info_card | info_card_reading_path_candidate | candidate | s8-harvest-reading-path-candidate | background-color, border, padding, line-height | section > p reading-path info box (harvest candidate) | green | WARNING | — | WECHAT_COPY_YELLOW_TAG, WECHAT_COPY_YELLOW_TAG | — | UNTESTED | — | Track in Matrix; Paste QA in STORY-006; waiver only with evidence · 006C changed Copy HTML; queued for 006D re-paste | candidate: not in default preset until Matrix PASS · sourceEvidenceId: WX-HARVEST-EVIDENCE-001 · release1Eligible: false · 006D-session-2026-06-05 · prev=UNTESTED (—) |
