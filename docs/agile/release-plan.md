...
| **下一 Sprint（规划）** | **P1-S12-002** Release 1 Closeout Readiness **In Review** · Sprint 12+ Compat·DSL 债务 / **Release 2** 候选见 [`releases/release-2/plan.md`](releases/release-2/plan.md)（**Planned / Not Started**） |
...
| **Sprint 12**  | Product Governance & Release 2 Planning    | 9 Story：文档体系 · R2 候选 · Closeout              | **Closed**（Accepted with follow-ups · **DECISION-124** · [`sprints/sprint-12/`](sprints/sprint-12/)） |
...
- Sprint 12：`sprint/s12-product-governance-r2-planning`（**Closed** · **DECISION-124** · 未 merge `release/1`）
