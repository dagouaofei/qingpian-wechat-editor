...
| **专项 Sprint（治理）** | **Sprint 12** — Product Governance & Release 2 Planning（**Approved / In Progress** · S12-STORY-001~009 **Done**（009 with follow-ups）· [`sprints/sprint-12/plan.md`](sprints/sprint-12/plan.md)） |
| **下一 Sprint（规划）** | Sprint 12 Closeout 待 PO 授权；**Release 2** 候选规划见 [`releases/release-2/plan.md`](releases/release-2/plan.md)（**Planned / Not Started**）                                                     |
...
| **Sprint 12**  | Product Governance & Release 2 Planning    | 9 Story：文档体系 · R2 候选 · Closeout 准备         | **Approved / In Progress**（001~009 Done · 009 with follow-ups · [`sprints/sprint-12/`](sprints/sprint-12/)） |
