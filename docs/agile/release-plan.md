...
| **专项 Sprint（治理）** | **Sprint 12** — Product Governance & Release 2 Planning（**Approved / In Progress** · S12-STORY-001~008 **Done** · S12-STORY-009 **In Review** · [`sprints/sprint-12/plan.md`](sprints/sprint-12/plan.md)） |
...
| **Sprint 12**  | Product Governance & Release 2 Planning    | 9 Story：文档体系 · R2 候选 · Closeout 准备         | **Approved / In Progress**（001~008 Done · 009 In Review · [`sprints/sprint-12/`](sprints/sprint-12/)） |
